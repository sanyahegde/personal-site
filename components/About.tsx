...
const About = () => {
  return (
    <section id="about" className="section-padding bg-white dark:bg-[#0a192f] relative overflow-hidden">
      <CodeBackground />
      <div className="container-custom max-w-5xl relative z-10">
        ...
        >
          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed mb-8 text-lg">
            <p>

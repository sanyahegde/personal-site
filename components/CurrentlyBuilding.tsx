...
const CurrentlyBuilding = () => {
  ...
  return (
    <section className="section-padding bg-[#0a192f] dark:bg-[#0a192f]">
      <div className="container-custom max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {items.map((item, index) => (
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border-2 border-white/20 hover:border-white/40 transition-all duration-300 shadow-sm hover:shadow-xl h-full">
